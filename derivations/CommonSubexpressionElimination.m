...
Modification: Pavel Kirienko (pavel.kirienko@gmail.com)
        . Added parameter ruleNamePrefix in order to avoid name clashing in generated code
*)
...
renumberVariables[prefix_,ceqns:{_,rules_}]:=
Module[{vnum=0},
        ceqns /. Map[#[[2]]->Symbol[prefix<>IntegerString[vnum++]]&,rules]
]

hoistCommonSubexpressions[expr_,ruleNamePrefix_:"v"]:=
renumberVariables[
        ruleNamePrefix,
        foldOneUseVariables[
                replaceRepeats[
